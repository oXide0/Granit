...
function Footer({ products, contacts, production, faq, scrollToSection }) {
			...
			<div className='footer__row'>
				...
				<div className='footer__col'>
					...
					{products === undefined ? (
						...
						<div className='footer__menu'>
							<p className='footer__subtitle' onClick={() => scrollToSection(products)}>
								Продукція
							</p>
							<Link to='/catalog' className='footer__subtitle'>
								Каталог
							</Link>
							<p className='footer__subtitle' onClick={() => scrollToSection(contacts)}>
								Контакти
							</p>
							<p className='footer__subtitle' onClick={() => scrollToSection(production)}>
								Виробництво
							</p>
							<p className='footer__subtitle' onClick={() => scrollToSection(faq)}>
								Поширені питання
							</p>
						</div>
					)}
				</div>
				<div className='footer__col application'>
