			...
			>
				...
				<SwiperSlide className='swiper__slide'>
					<div className='slide__col'>
						...
						<p className='start__subtitle'>
							Офісні столи з натурального каменю, кухонні гранітні стільниці з вирізами під мийку. Вибір
							варіантів обробки торця, скосна, півкругла та фігурна фаска.
						</p>
						<Link to='/catalog' className='start__button'>
							Перейти
						</Link>
				...
				<SwiperSlide className='swiper__slide'>
					<div className='slide__col'>
						...
						<p className='start__subtitle'>
							Підвіконня з граніту оптовими партіями - це Ваша можливість зробити свій бізнес в своєму
							місті, регіоні чи країні.
						</p>
						<Link to='/catalog' className='start__button'>
							Перейти
						</Link>
